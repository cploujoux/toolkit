...
export const getAgentLogs = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetAgentLogsData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetAgentLogsResponse, GetAgentLogsError, ThrowOnError>({
        ...options,
...
export const getFunctionLogs = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetFunctionLogsData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetFunctionLogsResponse, GetFunctionLogsError, ThrowOnError>({
        ...options,
 ...
 */
export const getModelLogs = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetModelLogsData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetModelLogsResponse, GetModelLogsError, ThrowOnError>({
        ...options,
