 ...
 */
export const listIntegrationModels = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ListIntegrationModelsData, ThrowOnError>) => {
    return (options?.client ?? client).get<ListIntegrationModelsResponse, ListIntegrationModelsError, ThrowOnError>({
        ...options,
 ...
 */
export const getIntegrationModel = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetIntegrationModelData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetIntegrationModelResponse, GetIntegrationModelError, ThrowOnError>({
        ...options,
 ...
 */
export const listModelProviders = <ThrowOnError extends boolean = false>(options?: OptionsLegacyParser<unknown, ThrowOnError>) => {
    return (options?.client ?? client).get<ListModelProvidersResponse, ListModelProvidersError, ThrowOnError>({
        ...options,
        url: '/model_providers'
    });
};
 ...
 */
export const createModelProvider = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<CreateModelProviderData, ThrowOnError>) => {
    return (options?.client ?? client).post<CreateModelProviderResponse, CreateModelProviderError, ThrowOnError>({
        ...options,
        url: '/model_providers'
    });
};
 ...
 */
export const deleteModelProvider = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<DeleteModelProviderData, ThrowOnError>) => {
    return (options?.client ?? client).delete<DeleteModelProviderResponse, DeleteModelProviderError, ThrowOnError>({
        ...options,
 ...
 */
export const getModelProvider = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetModelProviderData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetModelProviderResponse, GetModelProviderError, ThrowOnError>({
        ...options,
        url: '/model_providers/{modelProviderName}'
    });
};
 ...
 */
export const updateModelProvider = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<UpdateModelProviderData, ThrowOnError>) => {
    return (options?.client ?? client).put<UpdateModelProviderResponse, UpdateModelProviderError, ThrowOnError>({
        ...options,
        url: '/model_providers/{modelProviderName}'
    });
};
