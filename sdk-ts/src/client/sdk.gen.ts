 ...
 * Run information generation agent
 */
export const runInformationGenerationAgent = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<RunInformationGenerationAgentData, ThrowOnError>) => {
    return (options?.client ?? client).post<RunInformationGenerationAgentResponse, RunInformationGenerationAgentError, ThrowOnError>({
        ...options,
