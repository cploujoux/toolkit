 ...
 */
export const listAccounts = <ThrowOnError extends boolean = false>(options?: OptionsLegacyParser<unknown, ThrowOnError>) => {
 ...
 * Creates an account.
 */
export const createAccount = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<CreateAccountData, ThrowOnError>) => {
 ...
 */
export const getAccount = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetAccountData, ThrowOnError>) => {
 ...
 */
export const workspaceQuotasRequest = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<WorkspaceQuotasRequestData, ThrowOnError>) => {
    return (options?.client ?? client).put<WorkspaceQuotasRequestResponse, WorkspaceQuotasRequestError, ThrowOnError>({
        ...options,
        url: '/workspaces/{workspaceName}/quotas'
    });
};