 ...
 * Account
 */
export type Account = Metadata & AccountSpec & {
    metadata?: unknown;
    spec?: unknown;
};
 ...
 * AccountMetadata
 */
export type AccountMetadata = TimeFields & OwnerFields & {
    /**
     * Account id
     */
    id?: string;
...
export type ListAccountsResponse = (Array<Account>);
...
export type DeleteAccountError = (unknown);
