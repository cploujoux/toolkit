// Package beamlit provides primitives to interact with the openapi HTTP API.
//
...
func (c *ClientWithResponses) RegisterCliCommands(ctx context.Context) {

	// Register CLI commands for ListEnvironments
	RegisterCliCommand(ctx, "ListEnvironments", c.ListEnvironments)

	// Register CLI commands for DeleteEnvironment
	RegisterCliCommand(ctx, "DeleteEnvironment", c.DeleteEnvironment)

	// Register CLI commands for GetEnvironment
	RegisterCliCommand(ctx, "GetEnvironment", c.GetEnvironment)

	// Register CLI commands for CreateOrUpdateEnvironment
	RegisterCliCommand(ctx, "CreateOrUpdateEnvironment", c.CreateOrUpdateEnvironment)

	// Register CLI commands for GetEnvironmentMetrics
	RegisterCliCommand(ctx, "GetEnvironmentMetrics", c.GetEnvironmentMetrics)

	// Register CLI commands for ListLocations
	RegisterCliCommand(ctx, "ListLocations", c.ListLocations)

	// Register CLI commands for GetMetrics
	RegisterCliCommand(ctx, "GetMetrics", c.GetMetrics)

	// Register CLI commands for ListModelProviders
	RegisterCliCommand(ctx, "ListModelProviders", c.ListModelProviders)

	// Register CLI commands for DeleteModelProvider
	RegisterCliCommand(ctx, "DeleteModelProvider", c.DeleteModelProvider)

	// Register CLI commands for GetModelProvider
	RegisterCliCommand(ctx, "GetModelProvider", c.GetModelProvider)

	// Register CLI commands for CreateOrUpdateModelProvider
	RegisterCliCommand(ctx, "CreateOrUpdateModelProvider", c.CreateOrUpdateModelProvider)

	// Register CLI commands for ListModels
	RegisterCliCommand(ctx, "ListModels", c.ListModels)

	// Register CLI commands for DeleteModel
	RegisterCliCommand(ctx, "DeleteModel", c.DeleteModel)

	// Register CLI commands for GetModel
	RegisterCliCommand(ctx, "GetModel", c.GetModel)

	// Register CLI commands for CreateOrUpdateModel
	RegisterCliCommand(ctx, "CreateOrUpdateModel", c.CreateOrUpdateModel)

	// Register CLI commands for ListModelDeployments
	RegisterCliCommand(ctx, "ListModelDeployments", c.ListModelDeployments)

	// Register CLI commands for DeleteModelDeployment
	RegisterCliCommand(ctx, "DeleteModelDeployment", c.DeleteModelDeployment)

	// Register CLI commands for GetModelDeployment
	RegisterCliCommand(ctx, "GetModelDeployment", c.GetModelDeployment)

	// Register CLI commands for CreateOrUpdateModelDeployment
	RegisterCliCommand(ctx, "CreateOrUpdateModelDeployment", c.CreateOrUpdateModelDeployment)

	// Register CLI commands for GetModelDeploymentLogs
	RegisterCliCommand(ctx, "GetModelDeploymentLogs", c.GetModelDeploymentLogs)

	// Register CLI commands for GetModelDeploymentMetrics
	RegisterCliCommand(ctx, "GetModelDeploymentMetrics", c.GetModelDeploymentMetrics)

	// Register CLI commands for GetModelMetrics
	RegisterCliCommand(ctx, "GetModelMetrics", c.GetModelMetrics)

	// Register CLI commands for CreateModelRelease
	RegisterCliCommand(ctx, "CreateModelRelease", c.CreateModelRelease)

	// Register CLI commands for ListPolicies
	RegisterCliCommand(ctx, "ListPolicies", c.ListPolicies)

	// Register CLI commands for DeletePolicy
	RegisterCliCommand(ctx, "DeletePolicy", c.DeletePolicy)

	// Register CLI commands for GetPolicy
	RegisterCliCommand(ctx, "GetPolicy", c.GetPolicy)

	// Register CLI commands for CreateOrUpdatePolicy
	RegisterCliCommand(ctx, "CreateOrUpdatePolicy", c.CreateOrUpdatePolicy)

	// Register CLI commands for ListAllPendingInvitations
	RegisterCliCommand(ctx, "ListAllPendingInvitations", c.ListAllPendingInvitations)

	// Register CLI commands for ListModelsForProvider
	RegisterCliCommand(ctx, "ListModelsForProvider", c.ListModelsForProvider)

	// Register CLI commands for GetModelWithRepoForProvider
	RegisterCliCommand(ctx, "GetModelWithRepoForProvider", c.GetModelWithRepoForProvider)

	// Register CLI commands for ListOrganizationsForProvider
	RegisterCliCommand(ctx, "ListOrganizationsForProvider", c.ListOrganizationsForProvider)

	// Register CLI commands for ListStoreAgentTools
	RegisterCliCommand(ctx, "ListStoreAgentTools", c.ListStoreAgentTools)

	// Register CLI commands for GetStoreAgentTool
	RegisterCliCommand(ctx, "GetStoreAgentTool", c.GetStoreAgentTool)

	// Register CLI commands for ListTools
	RegisterCliCommand(ctx, "ListTools", c.ListTools)

	// Register CLI commands for DeleteTool
	RegisterCliCommand(ctx, "DeleteTool", c.DeleteTool)

	// Register CLI commands for GetTool
	RegisterCliCommand(ctx, "GetTool", c.GetTool)

	// Register CLI commands for CreateOrUpdateTool
	RegisterCliCommand(ctx, "CreateOrUpdateTool", c.CreateOrUpdateTool)

	// Register CLI commands for ListToolDeployments
	RegisterCliCommand(ctx, "ListToolDeployments", c.ListToolDeployments)

	// Register CLI commands for DeleteToolDeployment
	RegisterCliCommand(ctx, "DeleteToolDeployment", c.DeleteToolDeployment)

	// Register CLI commands for GetToolDeployment
	RegisterCliCommand(ctx, "GetToolDeployment", c.GetToolDeployment)

	// Register CLI commands for CreateOrUpdateToolDeployment
	RegisterCliCommand(ctx, "CreateOrUpdateToolDeployment", c.CreateOrUpdateToolDeployment)

	// Register CLI commands for ListWorkspaces
	RegisterCliCommand(ctx, "ListWorkspaces", c.ListWorkspaces)

	// Register CLI commands for CreateWorspace
	RegisterCliCommand(ctx, "CreateWorspace", c.CreateWorspace)

	// Register CLI commands for DeleteWorkspace
	RegisterCliCommand(ctx, "DeleteWorkspace", c.DeleteWorkspace)

	// Register CLI commands for GetWorkspace
	RegisterCliCommand(ctx, "GetWorkspace", c.GetWorkspace)

	// Register CLI commands for UpdateWorkspace
	RegisterCliCommand(ctx, "UpdateWorkspace", c.UpdateWorkspace)

	// Register CLI commands for DeclineInvitationToWorkspace
	RegisterCliCommand(ctx, "DeclineInvitationToWorkspace", c.DeclineInvitationToWorkspace)

	// Register CLI commands for AcceptInvitationToWorkspace
	RegisterCliCommand(ctx, "AcceptInvitationToWorkspace", c.AcceptInvitationToWorkspace)

	// Register CLI commands for LeaveWorkspace
	RegisterCliCommand(ctx, "LeaveWorkspace", c.LeaveWorkspace)

	// Register CLI commands for GetWorkspaceServiceAccounts
	RegisterCliCommand(ctx, "GetWorkspaceServiceAccounts", c.GetWorkspaceServiceAccounts)

	// Register CLI commands for CreateWorkspaceServiceAccount
	RegisterCliCommand(ctx, "CreateWorkspaceServiceAccount", c.CreateWorkspaceServiceAccount)

	// Register CLI commands for DeleteWorkspaceServiceAccount
	RegisterCliCommand(ctx, "DeleteWorkspaceServiceAccount", c.DeleteWorkspaceServiceAccount)

	// Register CLI commands for UpdateWorkspaceServiceAccount
	RegisterCliCommand(ctx, "UpdateWorkspaceServiceAccount", c.UpdateWorkspaceServiceAccount)

	// Register CLI commands for ListApiKeysForServiceAccount
	RegisterCliCommand(ctx, "ListApiKeysForServiceAccount", c.ListApiKeysForServiceAccount)

	// Register CLI commands for CreateApiKeyForServiceAccount
	RegisterCliCommand(ctx, "CreateApiKeyForServiceAccount", c.CreateApiKeyForServiceAccount)

	// Register CLI commands for DeleteApiKeyForServiceAccount
	RegisterCliCommand(ctx, "DeleteApiKeyForServiceAccount", c.DeleteApiKeyForServiceAccount)

	// Register CLI commands for ListUsersInWorkspace
	RegisterCliCommand(ctx, "ListUsersInWorkspace", c.ListUsersInWorkspace)

	// Register CLI commands for InviteUserToWorkspace
	RegisterCliCommand(ctx, "InviteUserToWorkspace", c.InviteUserToWorkspace)

	// Register CLI commands for RemoveUserFromWorkspace
	RegisterCliCommand(ctx, "RemoveUserFromWorkspace", c.RemoveUserFromWorkspace)

	// Register CLI commands for UpdateUserRoleInWorkspace
	RegisterCliCommand(ctx, "UpdateUserRoleInWorkspace", c.UpdateUserRoleInWorkspace)
