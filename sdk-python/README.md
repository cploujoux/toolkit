...
```python
from beamlit import AuthenticatedClient
...
```python
from beamlit.models import MyDataModel
from beamlit.api.my_tag import get_my_data_model
...
1. Any endpoint which did not have a tag will be in `beamlit.api.default`
